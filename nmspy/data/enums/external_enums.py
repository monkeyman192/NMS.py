...
class cGcMarkerType(IntEnum):
    ...
    PlanetRaid = 0x14
    Battle = 0x15
    SwarmHiveBattle = 0x16
    SpaceSignal = 0x17
    BlackHole = 0x18
    SpaceAnomalySignal = 0x19
    SpaceAtlasSignal = 0x1A
    GenericIcon = 0x1B
    NetworkPlayerFireTeam = 0x1C
    NetworkPlayerFireTeamShip = 0x1D
    NetworkPlayer = 0x1E
    NetworkPlayerShip = 0x1F
    NetworkPlayerVehicle = 0x20
    Monument = 0x21
    PlayerBase = 0x22
    EditingBase = 0x23
    MessageBeacon = 0x24
